...
| 3    | BAL  | -8.5 → -2.5       | 45.5  | 74.0% |

Top four retained: **TB, ATL, BAL**
...
| **BAL** | -8.5 → -2.5       | 45.5  | 2    | 74.0% | —                         | PRIMARY   | 🟢 LIVE  | —                                                              |
| PHI     | -7 → -1           | 39.5  | 2    | —     | 76.4% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| LAC     | -7 → -1           | 43.5  | 2    | —     | 74.7% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| NYJ     | +3 → +9           | 44    | 2    | —     | 74.5% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| CIN     | +3 → +9           | 45.5  | 2    | —     | 74.0% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| JAX     | +3 → +9           | 45.5  | 2    | —     | 74.0% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| TEN     | +7 → +13          | 39.5  | 1    | —     | 73.4% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
...
| NE      | -5.5 → +0.5       | 41.5  | 1    | —     | 72.5%                     | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (other half-point shape)                    |
| PIT     | +5.5 → +11.5      | 41.5  | 1    | —     | 72.5%                     | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (other half-point shape)                    |
| CAR     | -2.5 → +3.5       | 43.5  | 1    | —     | 71.7%                     | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (other half-point shape)                    |
| LV      | +7 → +13          | 43.5  | 1    | —     | 71.7% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| GB      | -3 → +3           | 44    | 1    | —     | 71.5% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| DEN     | -3 → +3           | 45.5  | 1    | —     | 71.0% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| HOU     | -3 → +3           | 45.5  | 1    | —     | 71.0% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| IND     | +6 → +12          | 46.5  | 1    | —     | 70.6% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| KC      | -6 → 0            | 46.5  | 1    | —     | 70.6% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line)                         |
| CHI     | -4.5 → +1.5       | 47    | 1    | —     | 70.5%                     | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (other half-point shape)                    |
| MIN     | +4.5 → +10.5      | 47    | 1    | —     | 70.5%                     | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (other half-point shape)                    |
| NYG     | +7 → +13          | 48    | 1    | —     | 70.2% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line) · FAILS TOTAL GUARDRAIL |
| DAL     | -4 → +2           | 51    | 1    | —     | 69.3% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line) · FAILS TOTAL GUARDRAIL |
| WAS     | +4 → +10          | 51    | 1    | —     | 69.3% ‡                   | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (whole-number line) · FAILS TOTAL GUARDRAIL |
...
| NO      | +8.5 → +14.5      | 45.5  | 0    | —     | 67.0%                     | SECONDARY | ⚪ PAPER | SECONDARY GEOMETRY (other half-point shape)                    |
...
| Highest **secondary** unadjusted research score | PHI -7 → -1 ‡      | 76.4% | Unadjusted research score | ⚪ SECONDARY / PAPER |

**3 secondary legs have a higher unadjusted research score than at least one PRIMARY/LIVE leg — but these values are not directly comparable, because secondary push handling is not modelled.** PHI 76.4% ‡, LAC 74.7% ‡, NYJ 74.5% ‡.
...
| `2026_02_NO_BAL-BAL`  | NO  | 45.5  | 0.6698722507821999 | 0.07 | 0.7398722507822    |
